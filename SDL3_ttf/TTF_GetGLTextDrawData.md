...
```c
TTF_GLAtlasDrawSequence * TTF_GetGLTextDrawData(TTF_Text *text);
```
...
([TTF_GLAtlasDrawSequence](TTF_GLAtlasDrawSequence) *) Returns a NULL
terminated linked list of
[TTF_GLAtlasDrawSequence](TTF_GLAtlasDrawSequence) objects or NULL if the
