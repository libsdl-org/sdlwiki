...
TTF_TextEngine * TTF_CreateGLTextEngine(void);                                                                                             // Create a text engine for drawing text with OpenGL.
TTF_TextEngine * TTF_CreateGLTextEngineWithProperties(SDL_PropertiesID props);                                                             // Create a text engine for drawing text with OpenGL, with extra properties.
TTF_GLAtlasDrawSequence * TTF_GetGLTextDrawData(TTF_Text *text);                                                                           // Get the geometry data needed for drawing the text.
void TTF_DestroyGLTextEngine(TTF_TextEngine *engine);                                                                                      // Destroy a text engine created for drawing text with OpenGL.
void TTF_SetGLTextEngineWinding(TTF_TextEngine *engine, TTF_GLTextEngineWinding winding);                                                  // Sets the winding order of the vertices returned by TTF_GetGLTextDrawData for a particular GL text engine.
TTF_GLTextEngineWinding TTF_GetGLTextEngineWinding(const TTF_TextEngine *engine);                                                          // Get the winding order of the vertices returned by TTF_GetGLTextDrawData for a particular GL text engine.
