...
We are obsessive about SDL3 having a backwards-compatible API. Whether you build your game using the Steam Runtime SDK or just about any other copy of SDL, it _should_ work with the one that ships with Steam.
