...
- [SDL_PEN_AXIS_BIDIRECTIONAL_MASKS](SDL_PEN_AXIS_BIDIRECTIONAL_MASKS)
- [SDL_PEN_AXIS_DISTANCE_MASK](SDL_PEN_AXIS_DISTANCE_MASK)
- [SDL_PEN_AXIS_PRESSURE_MASK](SDL_PEN_AXIS_PRESSURE_MASK)
- [SDL_PEN_AXIS_ROTATION_MASK](SDL_PEN_AXIS_ROTATION_MASK)
- [SDL_PEN_AXIS_SLIDER_MASK](SDL_PEN_AXIS_SLIDER_MASK)
- [SDL_PEN_AXIS_XTILT_MASK](SDL_PEN_AXIS_XTILT_MASK)
- [SDL_PEN_AXIS_YTILT_MASK](SDL_PEN_AXIS_YTILT_MASK)
- [SDL_PEN_DOWN_MASK](SDL_PEN_DOWN_MASK)
- [SDL_PEN_ERASER_MASK](SDL_PEN_ERASER_MASK)
- [SDL_PEN_INK_MASK](SDL_PEN_INK_MASK)
