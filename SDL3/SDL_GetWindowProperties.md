...
- [`SDL_PROP_WINDOW_OPENHARMONY_XCOMPONENT_POINTER`](SDL_PROP_WINDOW_OPENHARMONY_XCOMPONENT_POINTER):
  the OH_NativeXComponent associated with the window
- [`SDL_PROP_WINDOW_OPENHARMONY_WINDOW_POINTER`](SDL_PROP_WINDOW_OPENHARMONY_WINDOW_POINTER):
  the OHNativeWindow associated with the window
- [`SDL_PROP_WINDOW_OPENHARMONY_SURFACE_POINTER`](SDL_PROP_WINDOW_OPENHARMONY_SURFACE_POINTER):
  the EGLSurface associated with the window
