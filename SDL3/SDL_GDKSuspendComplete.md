...
When using [SDL_Render](SDL_Render), your event watch should be added
_after_ creating the [`SDL_Renderer`](SDL_Renderer); this allows the timing
of the D3D12 command queue suspension to execute in the correct order.
