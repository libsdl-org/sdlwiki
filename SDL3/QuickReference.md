...
SDL_PropertiesID SDL_GetGPUDeviceDebugProperties(SDL_GPUDevice *device);                                                                                                                                                                                                                                  // Returns a property group containing read-only debug information associated with this GPU context.
