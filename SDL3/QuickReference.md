...
SDL_PropertiesID SDL_GetAudioDeviceProperties(SDL_AudioDeviceID devid);                                                                                          // Get the properties associated with an audio device.
...
bool SDL_SetRenderViewportFloat(SDL_Renderer *renderer, const SDL_FRect *rect);                                                                                                                                                                                 // Set the drawing area for rendering on the current target.
bool SDL_GetRenderViewportFloat(SDL_Renderer *renderer, SDL_FRect *rect);                                                                                                                                                                                       // Get the drawing area for the current target.
...
bool SDL_SetRenderClipRectFloat(SDL_Renderer *renderer, const SDL_FRect *rect);                                                                                                                                                                                 // Set the clip rectangle for rendering on the specified target.
bool SDL_GetRenderClipRectFloat(SDL_Renderer *renderer, SDL_FRect *rect);                                                                                                                                                                                       // Get the clip rectangle for the current target.
