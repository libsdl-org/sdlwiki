...
Defined in [SDL_scancode.h](https://github.com/libsdl-org/SDL/blob/main/include/SDL3/SDL_scancode.h), but apps should _only_ `#include <SDL3/SDL.h>`!
...
in the `keysym.scancode` field of the
