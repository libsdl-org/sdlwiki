...
Refer to [CategoryAPI](CategoryAPI) for a list of functions, and the example [showfont.c](https://github.com/libsdl-org/SDL_ttf/blob/main/examples/showfont.c) for documentation on this library.
...
This library is under the zlib license, see the file [LICENSE.txt](https://github.com/libsdl-org/SDL_ttf/blob/main/LICENSE.txt) for details.
