...
|-
|'''packets'''
|an array of packets to send to the network.
|-
|'''npackets'''
|the number of packets in the <code>packets</code> array.
|}
...
the address in the <code>src</code> member of the packet.
...
you allocated individually, that is okay.
