...
If [[Mix_OpenAudioDevice]]() was called with <code>allowed_changes</code>
set to anything but zero, or [[Mix_OpenAudio]]() was used, some audio
device settings may be different from the application's request. This
