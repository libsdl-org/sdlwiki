...
|-
|'''ms'''
|number of milliseconds to fade before halting the group.
|}
...
current volumes to silence over <code>ms</code> milliseconds. After that
time, those channels are halted.
