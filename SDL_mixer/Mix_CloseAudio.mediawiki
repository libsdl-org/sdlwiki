...
function and [[Mix_Quit]](), some part of the application should be
...
call [[Mix_OpenAudio]] again, as the audio device may be in a new format
and the existing chunks will not be converted to match.
