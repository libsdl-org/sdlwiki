...
Refer to [CategoryAPI](CategoryAPI) for a list of functions, and the example [showimage.c](https://github.com/libsdl-org/SDL_image/blob/SDL2/examples/showimage.c) for documentation on this library.

This library is under the zlib License, see the file [LICENSE.txt](https://github.com/libsdl-org/SDL_image/blob/SDL2/LICENSE.txt) for details.
